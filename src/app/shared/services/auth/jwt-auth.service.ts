...
export class JwtAuthService {
  ...
  public signin(username, password) {
    ...
    this.signingIn = true;
    return this.http.post<AuthModel>(`${API_TOKEN_URL}/createToken`, { username, password })
      .pipe(
        map((res: any) => {
          
          console.log("rest" + res.authToken);
          console.log("restuser" + res.authUser);
          this.setUserAndToken(res.authToken, res.authUser, !!res);
          this.signingIn = false;
          return res;
        }),
        catchError((error) => {
  ...
  */
    ...
    //   var userName = email;
    //   return this.http.post<AuthModel>(`${API_TOKEN_URL}/createToken`, {
    //     userName,
    //     password,
    //   });
    // }
